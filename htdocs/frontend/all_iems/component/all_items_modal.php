...
<body>
    ...
    <?php foreach ($products as $product): ?>
        <div class="card"
            ...
            data-stock="<?= $product['stock'] ?>"> <!-- stock attribute added -->
            ...
            <?php else: ?>
                <div class="price-tag" style="background:crimson;">Out of Stock</div>
            <?php endif; ?>
        </div>
    <?php endforeach; ?>
</div>
    ...
    card.addEventListener('click', () => {
        ...
        currentProduct = { image, name, description, price, stock };
