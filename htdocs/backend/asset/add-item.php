...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (move_uploaded_file($image_tmp, $upload_path)) {
        $stmt = $conn->prepare("INSERT INTO items (item_name, item_description, item_price,stock, item_image) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("ssdis", $name, $description, $price, $stocks, $image_name);
