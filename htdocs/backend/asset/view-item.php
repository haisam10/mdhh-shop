...
if (isset($_POST['update'])) {
    ...
    $stmt->bind_param("ssdis", $name, $desc, $stocks, $price, $id);
    $stmt->execute();
    header("Location: view-item");
    exit;
}
...
<div class="d-flex">
    ...
    <main>
        ...
        <form method="post">
            ...
            <input type="text" name="stock" value="<?= htmlspecialchars($editItem['stock']) ?>" required>
            ...
            <tr>
                ...
                <td>
                    <?php if ($row['item_image']): ?>
                        <img src="http://localhost/frontend/all_iems/image/<?= htmlspecialchars($row['item_image']) ?>" alt="" class="img-fluid">
                    <?php else: ?>
                        No Image
                    <?php endif; ?>
                </td>
